...
public class TwoLineSeekBar extends View {
    ...
    private float mNailRadius = 1.0f;
    ...
    public TwoLineSeekBar(Context context, AttributeSet attrs) {
        ...
        mNailStrokeWidth = context.getResources().getDimension(com.intuit.sdp.R.dimen._2sdp);
        mLineWidth = context.getResources().getDimension(com.intuit.sdp.R.dimen._2sdp);
