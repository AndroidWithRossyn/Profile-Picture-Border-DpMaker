...
import com.profilemaker.dpgenerator.photoprofilepic.photoeditor.listener.MultiTouchListener;
...
import com.profilemaker.dpgenerator.photoprofilepic.photoeditor.views.EraseView;
...
public class EraseActivity extends BaseActivity implements OnClickListener, ToolAdapter.OnItemSelected{
    ...
    public void onCreate(Bundle bundle) {
        ...
        findViewById(R.id.ivDone).setOnClickListener(v -> SaveView());
        ...
        findViewById(R.id.ivChange).setOnClickListener(view -> changeBG());
