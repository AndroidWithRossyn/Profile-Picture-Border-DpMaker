...
import com.profilemaker.dpgenerator.photoprofilepic.photoeditor.model.ColorCode;
import com.profilemaker.dpgenerator.photoprofilepic.photoeditor.views.CircleView;
...
public class iColorAdapter extends RecyclerView.Adapter<iColorAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        if (this.iSelected == i) {
            viewHolder.tvTitle.setTextColor(ctx.getResources().getColor(R.color.mainColor));
            viewHolder.iColor.setStrokeColor(ctx.getResources().getColor(R.color.mainColor));
        } else {
            viewHolder.tvTitle.setTextColor(ctx.getResources().getColor(R.color.white));
            viewHolder.iColor.setStrokeColor(ctx.getResources().getColor(R.color.white));
        }
