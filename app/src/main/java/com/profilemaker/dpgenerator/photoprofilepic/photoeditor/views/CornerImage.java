package com.profilemaker.dpgenerator.photoprofilepic.photoeditor.views;
...
public class CornerImage extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public CornerImage(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CornerImage, defStyle, 0);

        mBorderWidth = a.getDimensionPixelSize(R.styleable.CornerImage_eStrokeWidth, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.CornerImage_eStrokeColor, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(R.styleable.CornerImage_eStrokeOverlay, DEFAULT_BORDER_OVERLAY);
        mCircleBackgroundColor = a.getColor(R.styleable.CornerImage_eBackground, DEFAULT_CIRCLE_BACKGROUND_COLOR);
