...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (this.iSelected == position) {
            holder.tvTitle.setTextColor(this.ctx.getResources().getColor(R.color.mainColor));
            holder.rfItem.setBorderColor(this.ctx.getResources().getColor(R.color.mainColor));
        } else {
            holder.tvTitle.setTextColor(this.ctx.getResources().getColor(R.color.white));
            holder.rfItem.setBorderColor(this.ctx.getResources().getColor(R.color.white));
        }
