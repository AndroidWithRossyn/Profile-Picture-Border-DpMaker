...
import static com.profilemaker.dpgenerator.photoprofilepic.photoeditor.utils.Constants.iDegJson;
...
import com.profilemaker.dpgenerator.photoprofilepic.photoeditor.adapters.ListAdapter;
...
import com.profilemaker.dpgenerator.photoprofilepic.photoeditor.adapters.iColorAdapter;
...
//                stickerViews.remove(stickerView);
    ...
    public void onCreate(Bundle bundle) {
        ...
        findViewById(R.id.iWhite).setOnClickListener(v -> iBg.setColorFilter(WHITE));

        findViewById(R.id.iBlack).setOnClickListener(v -> iBg.setColorFilter(BLACK));

        findViewById(R.id.ivHorizontal).setOnClickListener(v -> ImageFlipper.flip(iBg, FlipDirection.HORIZONTAL));

        findViewById(R.id.ivVertical).setOnClickListener(v -> ImageFlipper.flip(iBg, FlipDirection.VERTICAL));
